...
description: "The CSS Cascade is the algorithm used by browsers to resolve the conflict of which style rule to apply to an element when there are  2 or more style rules of the same property with different values targeting that element."
tags: ["CSS", "HTML",]
